...
pub fn set_x<SM: PioStateMachine>(sm: &SM, value: u32) {
...
pub fn get_x<SM: PioStateMachine>(sm: &SM) -> u32 {
...
pub fn set_y<SM: PioStateMachine>(sm: &SM, value: u32) {
    const OUT: u16 = InstructionOperands::OUT {
...
pub fn get_y<SM: PioStateMachine>(sm: &SM) -> u32 {
    const IN: u16 = InstructionOperands::IN {
        source: InSource::Y,
        bit_count: 32,
    }
...
pub fn set_pindir<SM: PioStateMachine>(sm: &SM, data: u8) {
...
pub fn set_pin<SM: PioStateMachine>(sm: &SM, data: u8) {
    let set: u16 = InstructionOperands::SET {
...
pub fn set_out_pin<SM: PioStateMachine>(sm: &SM, data: u32) {
    const OUT: u16 = InstructionOperands::OUT {
...
pub fn set_out_pindir<SM: PioStateMachine>(sm: &SM, data: u32) {
    const OUT: u16 = InstructionOperands::OUT {
...
pub fn exec_jmp<SM: PioStateMachine>(sm: &SM, to_addr: u8) {
